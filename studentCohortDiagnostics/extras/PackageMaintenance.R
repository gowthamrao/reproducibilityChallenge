...
#
# This file is part of OHDSISymposium2021Reproducibility
#
...
OhdsiRTools::checkUsagePackage("OHDSISymposium2021Reproducibility")
...
OhdsiRTools::createRenvLockFile(rootPackage = "OHDSISymposium2021Reproducibility",
