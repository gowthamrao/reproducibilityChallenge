...
outputFolder <- "D:/studyResults/OHDSISymposium2021Reproducibility"
...
for (i in (1:length(databaseIds))) {
  ...
  if (uploadToLocalPostGresDatabase) {
    uploadToLocalPostGresDatabaseSpecifications <- list(
      ...
      schema = 'OHDSISymposium2021Reproducibility',
...
#     stringr::str_squish("OHDSISymposium2021Reproducibility")
#   )
