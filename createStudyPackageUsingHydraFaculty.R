...
version <- "v0.1.0"
name <- "OHDSI Symposium 2021 reproducibility study Faculty"
packageName <- "OHDSISymposium2021ReproducibilityFaculty"
...
description <- "OHDSI Symposium 2021 reproducibility study Faculty"


library(magrittr)
# Set up
baseUrl <- "https://awsagunva1011.jnj.com:8443/WebAPI"
cohortIds <- c(23047:23049)
