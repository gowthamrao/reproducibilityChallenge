...
#
# This file is part of OHDSISymposium2021ReproducibilityFaculty
#
...
OhdsiRTools::checkUsagePackage("OHDSISymposium2021ReproducibilityFaculty")
...
OhdsiRTools::createRenvLockFile(rootPackage = "OHDSISymposium2021ReproducibilityFaculty",
