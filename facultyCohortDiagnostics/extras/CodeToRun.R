...
outputFolder <- "s:/OHDSISymposium2021ReproducibilityFaculty"
...
privateKeyFileName <- ""
userName <- ""
OHDSISymposium2021ReproducibilityFaculty::uploadResults(outputFolder, privateKeyFileName, userName)
